...
2. Run the cells to perform EDA and generate visualizations.
...
### **Task 2: Lookalike Model**
1. Open the Jupyter Notebook `FirstName_LastName_Lookalike.ipynb`.
2. Run the cells to build the Lookalike Model and generate recommendations.
...
### **Task 3: Customer Segmentation**
1. Open the Jupyter Notebook `FirstName_LastName_Clustering.ipynb`.
2. Run the cells to perform customer segmentation and evaluate clustering results.
